				...
				<div class="row">
					<div class="col-lg-4">
						<div class="pricetable <?= $membership_type == 0 ? 'active' : ''; ?>">
							...
							<a class="<?= $membership_type == 0 ? 'selected' : 'btn-hide'; ?>" href="<?= /*base_url()*/ 'javascript:;'; ?>" title="">
					...
					<div class="col-lg-4">
						<div class="pricetable <?= $membership_type == 1 ? 'active' : ''; ?>">
							...
							<a class="<?php if ($membership_type == 1) {
													echo 'selected';
												} elseif ($membership_type > 1) {
													echo 'btn-hide';
												} else {
													echo '';
												} ?>" href="<?= $membership_type < 1 ? base_url('payTMU/1') : 'javascript:;'; ?>" title="">
