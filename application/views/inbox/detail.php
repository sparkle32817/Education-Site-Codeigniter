                ...
                <div class="card b-all shadow-none">
                    ...
                    <div class="card-body">
                        <div class="d-flex m-b-40">
                            ...
                            <div class="p-l-10">
                                <h5 class="m-b-0">To: You</h5>
                                <h6 class="text-muted">From: <a href="javascript:;"><?= $information['name']; ?></a></h6>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="b-all m-t-20 p-20">
                            <p class="p-b-20">Click <a href="<?= base_url('inbox/reply/'.$id)?>"><b>here</b></a> to Reply</p>
                        </div>
                    </div>
                </div>
            </div>
