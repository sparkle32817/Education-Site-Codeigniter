            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12 mt-3">
                        <h5 class="text-center">You have purchased <b>Education Membership</b> successfully.</h5>
                    </div>
                    <div class="col-md-12 mt-5">
                        <a href="<?= base_url('membership'); ?>" class="pull-left"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
                        <a href="<?= base_url('home'); ?>" class="pull-right">Home&nbsp;<i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-md-3"></div>
            </div>
