$(document).ready(function () {
    ...
    $.each(reviews.reviews, function (index, review) {
        str_reviews += `<div class="emply-list">
                            ...
                            <div class="emply-list-info">
                                ...
                                <h3><a href="javascript:;" title="">Name:&nbsp;&nbsp;</a>` + review.name + `</h3>
    ...
    $(".form-review").on("submit", function (e) {
        ...
        $.ajax({
            url: base_url + "education/postReview",
            method: "post",
            data: {education_id: educationID, rating: curRating, description: description},
            dataType: "text",
            async: false,
    ...
    function getReviews() {
        ...
        $.ajax({
            url: base_url + "education/getReview",
            method: "post",
